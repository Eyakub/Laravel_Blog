...
<head>
    ...
    <script type="text/javascript" src="{{URL::to('http://html5shim.googlecode.com/svn/trunk/html5.js')}}"></script>
...
<div class="navbar">
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <a class="brand" href="admin_master.blade.php"><span>Metro</span></a>
                ...
                <ul class="nav pull-right">
                    ...
                    <li class="dropdown hidden-phone">
                        ...
                        <ul class="dropdown-menu messages">
                            ...
                            <li>
                                <a href="#">
                                    <span class="avatar"><img src="{{asset('admin_asset/img/avatar.jpg')}}"
                                                              alt="Avatar"></span>
                                    <span class="header">
                                                <span class="from">
                                                    Dennis Ji
        ...
        <div id="sidebar-left" class="span2">
            <div class="nav-collapse sidebar-nav">
                <ul class="nav nav-tabs nav-stacked main-menu">
                    ...
                    <li><a href="{{URL::to('/add-category')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> Add Category</span></a>
                    </li>
                    <li><a href="{{URL::to('/manage-category')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Manage Category</span></a>
                    </li>
                    <li><a href="{{URL::to('/add-blog')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> Add Blog</span></a>
                    </li>
                    <li><a href="{{URL::to('/manage-blog')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Manage Blog</span></a>
                    </li>
                    <li><a href="{{URL::to('/manage-comments')}}"><i class="icon-dashboard"></i><span
                                    class="hidden-tablet"> Manage Comments</span></a></li>
                    <li>

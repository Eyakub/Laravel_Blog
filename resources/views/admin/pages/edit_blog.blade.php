            ...
            <div class="box-content">
                ...
                <fieldset>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" value="{{$blog_info->blog_title}}" class="span6 typeahead"
                                   name="blog_title" id="typeahead">
                            <input type="hidden" value="{{$blog_info->blog_id}}" class="span6 typeahead"
                                   name="blog_id" id="typeahead">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            {{--js er kaj ache ekhne specific category drop-down e dhorte--}}
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input class="input-file uniform_on" value="{{$blog_info->blog_image}}" name="blog_old_image" id="fileInput" type="hidden">
                            <img src="{{asset($blog_info->blog_image)}}" width="30" height="70">
                        </div>
                    </div>
                    ...
                    <div class="control-group hidden-phone" style="margin-top: 20px;">
                        ...
                        <div class="controls">
                            <textarea class="cleditor" name="blog_short_description" id="textarea2"
                                      rows="3">{{$blog_info->blog_short_description}}</textarea>
                        </div>
                        ...
                        <div class="control-group hidden-phone" style="margin-top: 10px;">
                            ...
                            <div class="controls">
                                <textarea class="cleditor" name="blog_long_description"  id="textarea2"
                                          rows="3">{{$blog_info->blog_long_description}}</textarea>
                            </div>
                        </div>
